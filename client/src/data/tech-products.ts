...
export const categoryDescriptions: Record<string, string> = {
  "CRM": "Core donor database tracking gifts, pledges, events, moves management, and communications history",
  "Prospecting": "Identify, score, and prioritize high-capacity donors through philanthropic giving data and affinity scoring",
  "Analytics": "Visualize performance, donor trends, campaign results, and executive dashboards",
  "Grants": "Find new grants, track deadlines, and manage active grants in a centralized dashboard",
  "HR & Finance": "Enterprise platform for managing employees, payroll, recruiting, and compliance",
  "Clinical EHR": "Electronic health records and care-coordination for senior living and long-term care",
  "Transparency": "Nonprofit profiles, 990s, foundation giving history for due diligence and reputation management",
  "Coordination": "Web-based scheduling and coordination for volunteer sign-ups, events, and community activities"
};

export const categoryIntegrationNeeds: Record<string, "critical" | "high" | "medium"> = {
  "CRM": "critical",
  "Prospecting": "critical",
  "Analytics": "high",
  "Grants": "high",
  "HR & Finance": "critical",
  "Clinical EHR": "critical",
  "Transparency": "medium",
  "Coordination": "medium"
};
